    ...
    */
    ...
    public void SmallRectanglesContained()
    {
        ...
        */
        ...
        double smallLeft1 = display1.CenterPoint().X - sideLength / 2.0;
        double smallTop1 = display1.CenterPoint().Y - sideLength / 2.0;
        ...
        double smallLeft2 = display2.CenterPoint().X - sideLength / 2.0;
        double smallTop2 = display2.CenterPoint().Y - sideLength / 2.0;
        ...
        double smallLeft3 = display3.CenterPoint().X - sideLength / 2.0;
        double smallTop3 = display3.CenterPoint().Y - sideLength / 2.0;
    ...
    public void SmallRectanglesContained456()
    {
        ...
        double smallLeft4 = display4.CenterPoint().X - sideLength / 2.0;
        double smallTop4 = display4.CenterPoint().Y - sideLength / 2.0;
        ...
        double smallLeft5 = display5.CenterPoint().X - sideLength / 2.0;
        double smallTop5 = display5.CenterPoint().Y - sideLength / 2.0;
        ...
        double smallLeft6 = display6.CenterPoint().X - sideLength / 2.0;
        double smallTop6 = display6.CenterPoint().Y - sideLength / 2.0;
